"""
Django settings for ai_pic_bot project.
...
SECRET_KEY = 't3$tjs^2a98el60!98ivx)cbbfe3k8na3-g-bkm!^zn+^y%mvd'
...
INSTALLED_APPS = [
    ...
    'bot.apps.BotConfig',
    'maskbot.apps.MaskbotConfig', 
    'drawbot.apps.DrawbotConfig',
]
...
WSGI_APPLICATION = 'ai_pic_bot.wsgi.application'
