...
class MattingForm(forms.Form):
    ...
    size = forms.IntegerField(required=True, label="Boundary Size(Narrow-Thick)", label_suffix=":", initial=0, min_value=0, max_value=20,
    ...
    temp = forms.IntegerField(label="", label_suffix="", initial=0,
                                widget=forms.NumberInput(attrs={'readonly':True,'type':'hidden'}))
